  ...
  return (
    <section className="py-16 rounded-b-[100px] relative z-10">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl md:text-4xl lg:text-6xl font-mono font-bold mb-8 text-center">Marketing is Crucial... But I Get It, You&apos;re Busy.</h2>
            <p className="font-mono font-bold text-xl md:text-2xl mb-8 text-center max-w-2xl mx-auto py-8">
            ...
            <h3 className="text-3xl lg:text-4xl font-mono mb-6 text-center">You Need to Make Your Marketing Work for You.</h3>
            <h4 className="text-3xl lg:text-4xl font-mono font-semibold mb-4 text-center">But how?</h4>
            <div >
