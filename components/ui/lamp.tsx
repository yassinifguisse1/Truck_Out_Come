...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-screen flex-col items-center justify-center overflow-hidden dark:bg-slate-950 bg-white w-full rounded-b-[100px] rounded-t-[100px] z-0",
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        >
          ...
          <div className="absolute  w-[100%] right-0 dark:bg-slate-950 bg-white h-40 bottom-0 z-20 [mask-image:linear-gradient(to_top,white,transparent)]" />
        </motion.div>
        <div className="absolute top-1/2 h-48 w-full translate-y-12 scale-x-150 dark:bg-slate-950 bg-white blur-2xl"></div>
        ...
        <div className="absolute inset-auto z-40 h-44 w-full -translate-y-[12.5rem] dark:bg-slate-950 bg-white "></div>
      </div>
